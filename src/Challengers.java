...
public class Challengers {
    /* Class attributes */
    private HashMap<String, Challenger> challengers ;
    ...
    public void add(String name, String password){
        challengers.put(name, new Challenger(name,password,null)) ;
    ...
    private void file() {
        ...
        try{
            ...
            for(int i = 0 ; i < keys.length ; i++){ // iterate map by keys
                ...
                Challenger challenger = challengers.get(name); // challenger object 
    ...
    private void load() {
        ...
        try {
            ...
            while (scan.hasNextLine()) { // termination condition
                ...
                challengers.put(name, new Challenger(name, password, scores)); // add challenger object with key name
            }
        } catch (FileNotFoundException e) {
...
class Challenger {
     ...
     * Constructor to initialize variables
     */
    public Challenger(String name, String password, ArrayList<Integer> scores) {
        this.name = name;
